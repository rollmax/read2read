...
<div id="restore">
    <p class=warn>Контрольное изображение не верно</p>
    <p>Проверьте правильность ваших действий</p>
    <p>или пройдите регистрацию <a href="<?php echo url_for('static_page', array('url'=>'reader-rules')) ?>">заново</a></p>
</div>