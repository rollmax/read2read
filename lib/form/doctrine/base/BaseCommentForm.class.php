...
abstract class BaseCommentForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'comment_ru'   => new sfWidgetFormTextarea(),
      'comment_en'   => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'id_paragraph' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Paragraph'), 'required' => false)),
      'comment_ru'   => new sfValidatorString(),
      'comment_en'   => new sfValidatorString(),
